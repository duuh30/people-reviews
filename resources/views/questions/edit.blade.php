...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="POST" action="{{ route('questions.edit', $question->id) }}" autocomplete="off" class="form-horizontal">
                        {{ csrf_field() }}
                        <div class="card ">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-7">
                                        <div class="form-group{{ $errors->has('choice') ? ' has-danger' : '' }}">
                                            <input class="form-control{{ $errors->has('choice') ? ' is-invalid' : '' }}" {{ $question->choice ? 'checked' : '' }} name="choice" id="input-choice" type="checkbox" />
